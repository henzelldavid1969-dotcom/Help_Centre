...
Click the chat icon in the upper right corner.
{% endstep %}

{% step %}
### Add participants

Select + to start a new chat, then search for and select the members you want to include.
{% endstep %}
...
Inside each Space, there is the ability to chat with other members. Depending on the type of community you're in, your Host may or may not have this feature turned on.
...
You can record and send voice notes (up to 10 minutes) in any type of chat on web or mobile.

Voice notes include:

* Transcripts (with non-English language detection)
...
React with GIFs or emojis by selecting the icons in chat.

### Add Files

You can add files from your computer to a chat.

### Start a Conversation (AI-assisted)
...
Your Host may allow you to turn off individual private chat. If that's available, you'll find the option in:

Personal Settings > Chat
