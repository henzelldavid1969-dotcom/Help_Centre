...
To dive into your Mighty Network on a desktop, make sure you're using a browser that's up to date. We support the latest two versions of these leading browsers:
...
On the go? No problem! For mobile browser access, we recommend:
...
Prefer an app experience? Our Mighty Networks mobile apps are tailored to bring the power of your network to your fingertips. Supported versions:

* iOS or iPadOS 16+
* Android 7.0+

{% hint style="info" %}
Tips for a Mighty Experience
