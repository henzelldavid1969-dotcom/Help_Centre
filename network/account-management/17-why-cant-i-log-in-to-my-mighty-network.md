...
* **Correct URL:** Make sure you're using the correct URL for the Mighty Network you're trying to log into.
* **Correct Email Address:** Use the email address associated with your account when you first signed up. If you initially signed up using Social Sign In (Google, Facebook, LinkedIn, or Apple), try those options to log in. If you'd like to switch to signing in with your email, you'll need to reset your password.
* **Separate Logins for Each Network:** Every Mighty Network is standalone, meaning you'll need a separate profile and login for each one you're part of. You can use the same login information for each network if you prefer.
...
{% hint style="info" %}
Why was I logged out of my Mighty Network?

For security, login sessions on both web and mobile apps auto-renew regularly as long as you've accessed your Network in recent months. If it's been a while since your last visit, you may be asked to log in again.
{% endhint %}
