---
description: Understanding the Audit 16 Drinking Assessment.
---
...
* **Screening Purpose**: It helps in identifying potential alcohol-related issues and is used by healthcare professionals to assess the level of risk. ​
* **Adaptation for UK**: The tool has been modified to suit the UK context, ensuring relevance to local drinking patterns and healthcare practices.

The test has ten key questions which are scored to evaluate a person's harmful behaviour around alcohol. In some instances, the scores are used to allocate types of support within the service using the test.
...
If you'd like to do your own test you can [download it here.](https://assets.publishing.service.gov.uk/media/6357a7af8fa8f557d85b7c44/Alcohol-use-disorders-identification-test-AUDIT_for-print.pdf)
